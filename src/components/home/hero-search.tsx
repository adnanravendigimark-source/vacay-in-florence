    ...
    <div ref={containerRef} className="relative w-full max-w-5xl mx-auto">
      ...
      >
        ...
        <div className="relative flex-[1.4] group">
          ...
          {openDropdown === "search" && (
            <div className="absolute left-0 right-0 top-full z-50 mt-3 rounded-2xl border border-neutral-200/90 bg-white/98 backdrop-blur-2xl p-2.5 shadow-[0_24px_50px_rgba(0,0,0,0.35)] ring-1 ring-black/5 animate-in fade-in duration-100 text-neutral-900">
              ...
              <div className="mt-1 space-y-0.5">
                {SUGGESTIONS.map((item) => (
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-2 text-left text-xs text-neutral-800 hover:bg-neutral-100 transition-colors cursor-pointer"
                  >
